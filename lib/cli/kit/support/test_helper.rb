  ...
  module Kit
    module Support
      module TestHelper
        ...
        class FakeSuccess
          sig { params(success: T.untyped).returns(T.untyped) }
          ...
          module Kit
            module System
              class << self
                ...
                #
                sig do
                  params(a: T.untyped, stdout: T.untyped, stderr: T.untyped, allow: T.untyped, success: T.untyped, sudo: T.untyped,
                    env: T.untyped).returns(T.untyped)
                end
